 ...
 *         &lt;element name="br" type="{http://schemas.datacontract.org/2004/07/DataCheckEnquiry}Enquiry" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "validateBureauBusinessRules", namespace = "http://tempuri.org/")
public class ValidateBureauBusinessRules {
    ...
    @XmlElementRef(name = "br", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<Enquiry> br;
     ...
     *
     * @return possible object is
     * {@link JAXBElement }{@code <}{@link Enquiry }{@code >}
     */
    public JAXBElement<Enquiry> getBr() {
        return br;
    }
     ...
     *              {@link JAXBElement }{@code <}{@link Enquiry }{@code >}
     */
    public void setBr(JAXBElement<Enquiry> value) {
        this.br = value;
    }
