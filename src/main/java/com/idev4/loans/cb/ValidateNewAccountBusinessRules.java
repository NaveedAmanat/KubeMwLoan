 ...
 *         &lt;element name="ccp" type="{http://schemas.datacontract.org/2004/07/DataCheckEnquiry}CCPAdd" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "validateNewAccountBusinessRules", namespace = "http://tempuri.org/")
public class ValidateNewAccountBusinessRules {
    ...
    @XmlElementRef(name = "ccp", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<CCPAdd> ccp;
     ...
     *
     * @return possible object is
     * {@link JAXBElement }{@code <}{@link CCPAdd }{@code >}
     */
    public JAXBElement<CCPAdd> getCcp() {
        return ccp;
    }
     ...
     *              {@link JAXBElement }{@code <}{@link CCPAdd }{@code >}
     */
    public void setCcp(JAXBElement<CCPAdd> value) {
        this.ccp = value;
    }
