 ...
 *         &lt;element name="txn" type="{http://schemas.datacontract.org/2004/07/DataCheckEnquiry}PMTXN" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "ResolvePM", namespace = "http://tempuri.org/")
public class ResolvePM {
    ...
    protected JAXBElement<PMTXN> txn;
     ...
     *
     * @return possible object is
     * {@link JAXBElement }{@code <}{@link PMTXN }{@code >}
     */
    public JAXBElement<PMTXN> getTxn() {
        return txn;
    }
     ...
     *              {@link JAXBElement }{@code <}{@link PMTXN }{@code >}
     */
    public void setTxn(JAXBElement<PMTXN> value) {
        this.txn = value;
    }
