 ...
 *         &lt;element name="cr" type="{http://schemas.datacontract.org/2004/07/DataCheckEnquiry}CR2" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "getBureauCreditReportNew", namespace = "http://tempuri.org/")
public class GetBureauCreditReportNew {
     ...
     *
     * @return possible object is
     * {@link JAXBElement }{@code <}{@link CR2 }{@code >}
     */
    public JAXBElement<CR2> getCr() {
        return cr;
    }
     ...
     *              {@link JAXBElement }{@code <}{@link CR2 }{@code >}
     */
    public void setCr(JAXBElement<CR2> value) {
        this.cr = value;
    }
