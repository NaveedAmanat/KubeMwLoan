 ...
 *         &lt;element name="pe" type="{http://schemas.datacontract.org/2004/07/DataCheckEnquiry}PassEnquiry" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "CheckPasswordExpiry", namespace = "http://tempuri.org/")
public class CheckPasswordExpiry {
    ...
    @XmlElementRef(name = "pe", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<PassEnquiry> pe;
     ...
     *
     * @return possible object is
     * {@link JAXBElement }{@code <}{@link PassEnquiry }{@code >}
     */
    public JAXBElement<PassEnquiry> getPe() {
        return pe;
    }
     ...
     *              {@link JAXBElement }{@code <}{@link PassEnquiry }{@code >}
     */
    public void setPe(JAXBElement<PassEnquiry> value) {
        this.pe = value;
    }
