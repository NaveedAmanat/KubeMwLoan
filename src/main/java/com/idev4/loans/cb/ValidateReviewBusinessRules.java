 ...
 *         &lt;element name="rev" type="{http://schemas.datacontract.org/2004/07/DataCheckEnquiry}Review" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "validateReviewBusinessRules", namespace = "http://tempuri.org/")
public class ValidateReviewBusinessRules {
    ...
    @XmlElementRef(name = "rev", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<Review> rev;
     ...
     */
    public JAXBElement<Review> getRev() {
        return rev;
    }
     ...
     *              {@link JAXBElement }{@code <}{@link Review }{@code >}
     */
    public void setRev(JAXBElement<Review> value) {
        this.rev = value;
    }
