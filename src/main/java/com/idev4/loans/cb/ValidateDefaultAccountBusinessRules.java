 ...
 *         &lt;element name="def" type="{http://schemas.datacontract.org/2004/07/DataCheckEnquiry}DefaultAdd" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "validateDefaultAccountBusinessRules", namespace = "http://tempuri.org/")
public class ValidateDefaultAccountBusinessRules {
    ...
    @XmlElementRef(name = "def", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<DefaultAdd> def;
     ...
     *
     * @return possible object is
     * {@link JAXBElement }{@code <}{@link DefaultAdd }{@code >}
     */
    public JAXBElement<DefaultAdd> getDef() {
        return def;
    }
     ...
     *              {@link JAXBElement }{@code <}{@link DefaultAdd }{@code >}
     */
    public void setDef(JAXBElement<DefaultAdd> value) {
        this.def = value;
    }
