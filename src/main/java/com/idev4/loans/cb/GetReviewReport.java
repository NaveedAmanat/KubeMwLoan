 ...
 *         &lt;element name="rr" type="{http://schemas.datacontract.org/2004/07/DataCheckEnquiry}RR" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "getReviewReport", namespace = "http://tempuri.org/")
public class GetReviewReport {
    ...
    @XmlElementRef(name = "rr", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<RR> rr;
     ...
     *
     * @return possible object is
     * {@link JAXBElement }{@code <}{@link RR }{@code >}
     */
    public JAXBElement<RR> getRr() {
        return rr;
    }
     ...
     *              {@link JAXBElement }{@code <}{@link RR }{@code >}
     */
    public void setRr(JAXBElement<RR> value) {
        this.rr = value;
    }
