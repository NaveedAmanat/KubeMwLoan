...
public class TabClientBasicInfo implements Serializable {
    ...
    public Long ref_cd_ph_typ_seq;

    public Long sim_rgstr_by_clnt;

    public Long ref_cd_loan_usr;
    ...
    public String toString() {
        return "ClntBasicInfoDto{" +
                ...
                ", ref_cd_ph_typ_seq='" + ref_cd_ph_typ_seq + '\'' +
                ", sim_rgstr_by_clnt='" + sim_rgstr_by_clnt + '\'' +
                ", ref_cd_loan_usr='" + ref_cd_loan_usr + '\'' +
                '}';
    }

    public MwClient DtoToDomain(DateFormat formatter, DateFormat simpleFormatter, MwClient clnt) {
        ...
        clnt.setMnthsRes(mnths_res == null ? 0L : mnths_res);
        ...
        clnt.setYrsRes(yrs_res == null ? 0L : yrs_res);
        ...
        clnt.setRefCdPhTypSeq(ref_cd_ph_typ_seq);
        clnt.setSimRgstrByClnt(sim_rgstr_by_clnt);
        clnt.setRefCdLoanUsr(ref_cd_loan_usr);
        return clnt;
    }

    public void DomainToDto(MwClient clnt) {
        ...
        ref_cd_ph_typ_seq = clnt.getRefCdPhTypSeq();
        sim_rgstr_by_clnt = clnt.getSimRgstrByClnt();
        ref_cd_loan_usr = clnt.getRefCdLoanUsr();
    }
}
