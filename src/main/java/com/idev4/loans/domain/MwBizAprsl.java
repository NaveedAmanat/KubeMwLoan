...
public class MwBizAprsl implements Serializable {
    ...
    @Column(name = "biz_dtl_str")
    private String bizDtlStr;
    ...
    public String getBizDtlStr() {
        return bizDtlStr;
    }

    public void setBizDtlStr(String bizDtlKey) {
        this.bizDtlStr = bizDtlKey;
    }

    public MwBizAprsl bizDtlStr(String bizDtlStr) {
        this.bizDtlStr = bizDtlStr;
        return this;
    }
    ...
    public String toString() {
        return "MwBizAprsl{" +
                ...
                ", mnthInBiz=" + mnthInBiz +
                ", mwLoanApp=" + mwLoanApp +
                ", bizAddrSameAsHomeFlg=" + bizAddrSameAsHomeFlg +
                ", bizPropertyOwnKey=" + bizPropertyOwnKey +
                ", bizPhNum='" + bizPhNum + '\'' +
                ", syncFlg=" + syncFlg +
                ", remarks='" + remarks + '\'' +
                '}';
