...
@Entity
@Table(name = "MW_BIZ_APRSL_EST_LVSTK_FIN")
// @IdClass ( MwBizAprslEstLvstkFinId.class )
public class MwBizAprslEstLvstkFin implements Serializable {

    private static final long serialVersionUID = 1L;

    @Id
    @Column(name = "BIZ_APRSL_EST_LVSTK_FIN_SEQ")
    private Long bizAprslEstLvstkFinSeq;
    ...
    @Column(name = "AMT_BY_CLIENT")
    private Long amtByClient;
    ...
    public Long getBizAprslEstLvstkFinSeq() {
        return bizAprslEstLvstkFinSeq;
    }

    public void setBizAprslEstLvstkFinSeq(Long bizAprslEstLvstkFinSeq) {
        this.bizAprslEstLvstkFinSeq = bizAprslEstLvstkFinSeq;
    }
    ...
    public Long getAmtByClient() {
        return amtByClient;
    }

    public void setAmtByClient(Long amtByClient) {
        this.amtByClient = amtByClient;
    }

    public Long getAmtFin() {
        return amtFin;
    }

    public void setAmtFin(Long amtFin) {
        this.amtFin = amtFin;
    }
